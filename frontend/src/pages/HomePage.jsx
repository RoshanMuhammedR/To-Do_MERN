...
const HomePage = () => {
  ...
  const {isOpen,choosenMenu,tasks,getData,getQuote} = useSidebarStore()
      ...
      <div className="flex-1">
        ...
        <div className='h-screen w-[100%] flex'> 
          ...
          <div className='p-5 m-3 w-[100%]  bg-gray-100 rounded'>
            ...
            {choosenMenu=='Today' ? <Today /> : ""} 
          </div>



          {choosenTask ?  (
            <div className=' p-5 mt-3 mb-3 mr-3 w-[50%] bg-gray-100 rounded overflow-y-auto max-h-[100%]'>
